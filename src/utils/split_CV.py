...
if __name__ == "__main__":
    ...
    DIR_IMAGE = f'{cfg.data_dir}/JPEGImages'
    DIR_CV = f'{cfg.data_dir}/ImageSets'
    ...
    for k in range(0, cfg.K_FOLD):
        ...
        print(f"fold_{k}: train-{len(train_list)}, val-{len(val_list)}")
        ...
        #             continue
        #         Newdir = os.path.join(os.path.abspath(os.path.join(path, "../")),
        #                               name + str(count + int(startNumber)).rjust(6, '0') + fileType)
